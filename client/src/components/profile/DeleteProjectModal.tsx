...
import { verifyPassword } from '@/services/ProfileService';
import { toast } from 'react-toastify';
import { VerifyPasswordForm } from '@/types/index';
import { deleteProjectById } from '@/services/ProjectService';

export default function DeleteProjectModal() {
    const initialValues : VerifyPasswordForm = {
        password: ''
    }
    ...
    const handleForm = async (formData: VerifyPasswordForm) => {
        await verifyPasswordMutation.mutateAsync(formData);
